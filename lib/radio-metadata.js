...
class RadioMetadataManager {
            ...
            <div class="metadata-grid">
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="radio-isrc" class="form-input" 
                           placeholder="ZA-80G-YY-NNNNN (auto-generated)" maxlength="15">
                    <small class="field-help">International Standard Recording Code - Professional format with 80G registrant</small>
                </div>
    ...
    populateFromAudioMetadata(audioMetadata) {
        ...
        const genreField = document.getElementById('radio-genre-select');
    ...
    getTrackMetadata() {
        ...
        const metadata = {
            ...
            genre: this.userInputManager.getValue('radio-genre', this.getFieldValue('radio-genre-select'), 'Electronic'),
            ...
            contentRating: this.userInputManager.getValue('radio-explicit', this.getFieldValue('radio-explicit'), 'clean'),
