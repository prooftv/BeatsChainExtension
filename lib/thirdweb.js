...
class ThirdwebManager {
    ...
    async initialize(privateKey) {
        try {
            ...
            this.rpcUrl = await config.get('RPC_URL');
            this.clientId = await config.get('THIRDWEB_CLIENT_ID');
    ...
    async mintNFT(recipientAddress, metadataUri) {
        try {
            ...
            // Skip external API calls and use direct generation
            console.log('Using direct transaction generation for reliability...');
