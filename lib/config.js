  ...
  async initialize() {
    ...
    try {
      ...
      const defaults = {
        ...
        RPC_FALLBACK_1: 'https://rpc-mumbai.matic.today',
        RPC_FALLBACK_2: 'https://matic-mumbai.chainstacklabs.com',
        RPC_FALLBACK_3: 'https://polygon-testnet.public.blastapi.io',
