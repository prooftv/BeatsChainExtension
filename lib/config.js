...
class ConfigManager {
  ...
  async initialize() {
    ...
    try {
      ...
      const defaults = {
        RPC_URL: stored['NEXT_PUBLIC_RPC_URL'] || 'https://polygon-mumbai.g.alchemy.com/v2/YourAlchemyKey',
        RPC_FALLBACK_1: 'https://rpc.ankr.com/polygon_mumbai',
        RPC_FALLBACK_2: 'https://polygon-mumbai.blockpi.network/v1/rpc/public',
        RPC_FALLBACK_3: 'https://endpoints.omniatech.io/v1/matic/mumbai/public',
        CONTRACT_ADDRESS: stored['NEXT_PUBLIC_CONTRACT_ADDRESS'] || '0x742d35Cc6634C0532925a3b8D4C9db96C4b5Da5A',
