...
- Quality: ${metadata.qualityLevel} (${metadata.estimatedBitrate})
- Format: ${metadata.format} (${metadata.fileSize})
...
- Smart contract address: 0x8B7F8B2B8B7F8B2B8B7F8B2B8B7F8B2B8B7F8B2B
